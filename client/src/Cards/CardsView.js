...
function ActionBar(props) {
    ...
    return <div className="top-toolbar">
        ...
        {<React.Fragment><WarningModal warningText="This will save your card and remove the history from the undo and redo stacks. Are you sure you want to save?" action_name="Save" title="Save card" continueAction={e => handleSave(e)} trigger={
            <Button icon={<Icon className="right">save</Icon>} className="btn btn-primary" onClick={e => handleSave(e)} type="submit" tooltip="Save current card changes" disabled={!(isOwner||isContributor)}>
        ...
        {<Button icon={<Icon className="right">undo</Icon>} onClick={_ => props.undoContent()} className="btn btn-primary"
            type="submit" id="undo" tooltip="Undo your last change!" disabled={undoFlag||!isOwner}>
        ...
        {<Button icon={<Icon className="right">redo</Icon>} onClick={_ => props.redoContent()} className="btn btn-primary"
            type="submit" id="redo"  tooltip="Redo your last undo!" disabled={redoFlag||!isOwner}>
        ...
        {<CloneModal usersID={props.auth.user.id} cardEditor={props.editor} action_name="Save Card" title="Clone card"  trigger={
                <Button icon={<Icon className="right">content_copy</Icon>} className="btn btn-primary" type="submit" tooltip="Clone this card!" disabled={isOwner||isContributor}>
        ...
        {<AddCollaborators username={props.auth.user.username} cardEditor={props.editor} trigger={
                <Button icon={<Icon className="right">people</Icon>} className="btn btn-primary" type="submit" tooltip="Add Collaborators to this set!" disabled={!isOwner}>
